...
(function (factory) {
	...
	function addElementToLeftButtons() {

		var $buttonImgMounth = $("<div class='button-img'></div>");
		var $buttonImgWeek = $("<div class='button-img'></div>");
		var $buttonImgDay = $("<div class='button-img'></div>");
		var count = document.getElementsByClassName("button-img").length;

		if (count == 0) {
			$(".fc-month-button").text("");
			$(".fc-agendaWeek-button").text("");
			$(".fc-agendaDay-button").text("");
			$(".fc-month-button").append($buttonImgMounth);
			$(".fc-agendaWeek-button").append($buttonImgWeek);
			$(".fc-agendaDay-button").append($buttonImgDay);
			$buttonImgMounth.text("month");
			$buttonImgWeek.text("week");
			$buttonImgDay.text("day");
			activeView();
		} else {
			var $buttonImgMounth = $("<div class='button-img'>month</div>");
			var $buttonImgWeek = $("<div class='button-img'>week</div>");
			var $buttonImgDay = $("<div class='button-img'>day</div>");
			$(".fc-month-button").text("");
			$(".fc-agendaWeek-button").text("");
			$(".fc-agendaDay-button").text("");
			$(".fc-month-button").append($buttonImgMounth);
	...
	function activeView() {
		//jQuery exspasion code listen to activeView mode To set View click button
		$('.button-img').css("background-image", "url('http://justrun.site/images/button_un-clicked.svg')");
		var getView = $('.fc-month-button > .button-img')
		$(getView).css("background-image", "url('http://justrun.site/images/button_clicked.svg')");
		$(".fc-month-button > .button-img").click(function (event) {
			var target = $(event.target)
			$(".button-img").css("background-image", "url('http://justrun.site/images/button_un-clicked.svg')");
			$(target).css("background-image", "url('http://justrun.site/images/button_clicked.svg')");
		})
		$(".fc-agendaWeek-button > .button-img").click(function (event) {
			setTimeout(function(){
				$(".button-img").css("background-image", "url('http://justrun.site/images/button_un-clicked.svg')");
			$(".fc-agendaWeek-button > .button-img").css("background-image", "url('http://justrun.site/images/button_clicked.svg')");
			}, 10);
			
		})
		$(".fc-agendaDay-button > .button-img").click(function (event) {
			var target = $(event.target)
			setTimeout(function(){
			$(".button-img").css("background-image", "url('http://justrun.site/images/button_un-clicked.svg')");
			$(".fc-agendaDay-button > .button-img").css("background-image", "url('http://justrun.site/images/button_clicked.svg')");
				}, 10);
		})
	};
